...
from gladier_ptycho.flows.pytcho_pure_flow import *
from gladier_ptycho.deployments import deployment_map
import re

def arg_parse():
    parser = argparse.ArgumentParser()
    parser.add_argument('--pathname', help='input file pathname',
                        default='/lus/theta-fs0/projects/ExaLearn/rchard/test_ptycho/extracted_scan350.h5')
    parser.add_argument('--output_dir', help='Output Directory on theta',
                        default='/lus/theta-fs0/projects/ExaLearn/rchard/test_ptycho/output/recons/06/')
    parser.add_argument('--group', help='Visibility in Search', default=None)
    parser.add_argument('--deployment','-d', default='tekin-prod', help=f'Deployment configs. Available: {list(deployment_map.keys())}')
...
if __name__ == '__main__':
    ...
    payload = {'pathname': args.pathname,
